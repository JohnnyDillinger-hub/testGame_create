...
void PostProcessor::SetShake(bool shake)
{
   
    if (shake != true && shake != false)
        std::cout << "ERROR::POSTPROCESSOR: Failed to set this->Shake variable" << std::endl;
    else
        this->Shake = shake;
