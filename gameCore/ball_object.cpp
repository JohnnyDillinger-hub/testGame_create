...
glm::vec2 BallObject::Move(float dt, unsigned int window_width)
{
	...
	if (!this->Stuck)
	{
		...
		// Затем проверяем, находится ли мяч за пределами границ окна, и если да, то изменяем скорость и восстанавливаем правильное положение
...
void BallObject::Reset(glm::vec2 position, glm::vec2 velosity)
{
