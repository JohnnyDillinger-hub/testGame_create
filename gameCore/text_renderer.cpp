...
TextRenderer::TextRenderer(unsigned int width, unsigned int height)
{
	...
	this->TextShader = ResourceManager::LoadShader("C:/user/programming/repos_VS2019/game_testCreated/game_testCreated/shaders/text_2d.vs",
		"C:/user/programming/repos_VS2019/game_testCreated/game_testCreated/shaders/text_2d.vs", nullptr, "text");
...
void TextRenderer::Load(std::string font, unsigned int fontSize)
{
    ...
    // Устанавливаем размер шрифта в качесвте face
    FT_Face face;
